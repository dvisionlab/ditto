<template>
  <div>
    <component
      ...
      :disabled="
        loading || (field.disabled ? field.disabled(field, formValue) : false)
      "
      :hint="field.hint"
      :label="field.label"
      :required="required"
...
export default {
  ...
  props: {
    ...
    formValue: { default: () => ({}), type: Object },
    loading: { default: false, type: Boolean },
    value: { required: false, type: [Boolean, String] }
  },
  computed: {
    localValue: {
      get: function () {
    ...
    required() {
      return this.field.required
        ? this.field.required(this.field, this.formValue)
        : false;
    }
  },
  methods: {
