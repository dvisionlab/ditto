...
| **getImageIdsFn**       | the function the component should use to get the series loading status; should return the list of the image ids                                               | Array          | (store, seriesId) => (store.state.larvitar.series[seriesId]                 |  | {}).imageIds |
