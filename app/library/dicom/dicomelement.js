/**
 * @typedef {Object} DicomElement standard DICOM element
 * @property {string} tag tag-number
 * @property {string} vr value representation
 * @property {string} vm value multiplicity
 * @property {string} name keyword
 */

/**
 * Dicom standard data elements
 * @type {DicomElement[]}
 */
const DicomElements = {
  /*eslint-disable */
  ...
  // private
  "70010055": { tag: "(7001,0055)", vr: "LO", vm: "1", name: "InstanceURL" }
  /* eslint-enable */
};

export default DicomElements;
